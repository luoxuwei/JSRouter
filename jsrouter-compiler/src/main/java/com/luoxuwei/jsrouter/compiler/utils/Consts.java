...
public class Consts {
    ...
    public static final String IROUTE_GROUP = PACKAGE + TEMPLATE_PACKAGE + ".IRouteGroup";
    public static final String ITROUTE_ROOT = PACKAGE + TEMPLATE_PACKAGE + ".IRouteRoot";
